...
# park.sh: park the array using the GH RT-21 Az-El rotor controller
...
# spawn az
rotctld -m 405 -s 4800 -C min_az=-5,max_az=360,min_el=0,max_el=0,timeout=5000,retry=2 -t 4535 -r /dev/ttyUSB1 &
